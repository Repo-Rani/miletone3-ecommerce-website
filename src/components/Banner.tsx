  ...
  return (
    <>
      ...
      <span 
        ...
        data-aos="fade-right"
        data-aos-delay="200"
      className="relative left-[15px] top-[-445px] sm:left-[20px] sm:top-[-430px]  xxl:left-[230px] lg:left-[110px]  md:left-[100px] md:top-[-410px] xxxl:left-[220px] xxxl:top-[-480px] xxl:top-[-460px] xl:top-[-400px] xl:left-[240px] lg:top-[-420px] tracking-wide font-lato text-[12px] xsm:text-[14px] md:text-[16px] text-white">
        NEW RELEASE
      </span>
      <h1
       data-aos="fade-right"
