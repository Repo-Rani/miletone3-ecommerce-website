...
const Banner = () => {
  return (
    <>
      <div className="relative  md:w-full h-[70vh] md:h-screen xxl:top-[115px] xl:top-[108px]  md:top-[105px] ">
