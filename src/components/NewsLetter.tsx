      ...
      <div className="w-full lg:h-[230px] h-[170px]  xl:px-20 px-6 lg:py-16 py-6 bg-[#735555]">
        <div className="flex justify-between items-center lg:flex-row flex-col">
          <div className="flex flex-col gap-[10px]">
            <h1 className="relative md:top-[-40px] md:left-[420px] xl:text-[38px] lg:text-[35px] md:text-[31px] text-[25px] leading-[20px] whitespace-nowrap text-white font-medium uppercase font-greatVibes">
            Are you on <span className="font-extrabold font-greatVibes">the list?</span> 
            </h1>
            <p className="lg:text-[15px] md:top-[-30px] md:text-[14px] text-[12px] text-white text-center  relative md:left-[410px] font-normal font-lato">
            Join to get exclusive offers & discounts.
            </p>
          </div>
          <div className="flex justify-center relative md:top-[50px] md:right-[380px] gap-[10px] mt-6">
            <input
              type="text"
