...
const Navbar = ({ openNav }: NavbarPropsType) => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between w-[160%] md:w-[95%] mx-auto h-[12vh]">
        {isSearchActive ? (
          ...
          <>
            ...
            <div className="flex justify-between w-[70%] lg:w-[65%] space-x-8">
              <div className="hidden md:flex items-center xl:space-x-6 lg:space-x-5 md:space-x-3 text-white whitespace-nowrap md:text-[10px] lg:text-[14px] xl:text-[16px] uppercase">
              ...
              <div className="relative flex items-center justify-end gap-[20px]">
              ...
              <HiBars3BottomRight
                onClick={openNav}
                className="h-6 w-6 cursor-pointer text-white hover:scale-110 transition-all duration-300 ease-linear md:hidden"
              />
            </div>
          </>
        )}
