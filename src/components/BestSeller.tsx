...
const BestSeller = ({
  ...
  return (
    <div className="best-seller relative mx-auto   ">
      ...
      <div
        className="xxxl:w-[300px] md:w-[290px] sm:w-[400px] w-[320px]  lg:w-[330px] xl:w-[285px] md:h-[350px]  h-[485px] flex flex-col justify-center items-center  px-10 cursor-pointer relative"
      ...
      >
        ...
        {isHovered && (
          <button
            ...
            className="relative top-[40px] md:top-[50px] md:text-[16px] text-[14px]  px-6 py-2 bg-transparent text-black border-[1px] border-black rounded hover:bg-black hover:text-white hover:scale-105 transition-all ease-in-out duration-300"
          >
            Add to Cart
          </button>
        )}
