...
const FacePage = () => {
  ...
  return (
    <>
    <section className='h-[1800px] w-full'>
  ...
  <div className="w-[100px] h-[400px] flex justify-between flex-col relative top-[30px]">
   ...
   <Image src='/face-route.webp' alt='best seller' quality={100}  priority height={400} width={1100} className='h-[400px] w-[1100px]'/>
  ...
  <h2 className='text-[48px] text-black font-bold font-playfair'>Face</h2>
