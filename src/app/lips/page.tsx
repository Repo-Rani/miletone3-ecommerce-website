...
<Image src='/lips-route.webp' alt='best seller' quality={100}  priority height={400} width={1100} className='h-[400px] w-[1100px]'/>
   ...
   <Image src='/lips-route.webp' alt='best seller' 
    ...
    <h2  data-aos="fade-right"
        data-aos-delay="200"  className='relative xl:top-0 w-[250px] xxxl:left-[-60px] xxxl:top-[-50px] xl:left-[40px] md:left-[-170px] md:top-[-210px] lg:left-[-120px] lg:top-[-60px] lg:text-[48px] xsm:top-0 sm:top-[-50px] top-[-50px] xsm:text-[32px] text-[30px] text-black font-bold font-playfair xsm:top-[-70px]whitespace-nowrap'>Lips</h2>
...
<div className="relative xxxl:top-[-70px] xl:top-[-80px]  xl:left-[-85px] xxxl:left-[-80px] lg:top-[-30px] md:top-[-180px] xsm:top-[-150px] top-[-150px] sm:top-[-140px] md:left-0 xsm:left-[50px] sm:left-[20px]"><Lips/>
</div>
    </div>
