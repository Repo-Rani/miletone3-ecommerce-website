...
<Image src='/shopall.webp' alt='best seller' quality={100}  priority height={400} width={1100} className='h-[400px] w-[1100px]'/>
  ...
  <h2  data-aos="fade-right"
        data-aos-delay="200"  className='relative xl:top-0 xxxl:left-[60px] xl:left-[40px] md:left-[-170px] md:top-[-210px] lg:left-[-125px] lg:top-[-60px] lg:text-[48px] xsm:text-[32px] text-[30px] text-black font-bold font-playfair whitespace-nowrap xsm:top-[-60px]  top-[-50px]'>Shop All</h2>
...
<div className='relative lg:top-0 md:top-[-150px] md:left-0 xsm:top-[-160px] xsm:left-[40px] top-[-130px] sm:left-0 left-[-20px]'>
    <ShopAll/>
</div>
